# Star-Office-UI Skills 开发参考手册

**基于 Star-Office-UI 项目的最佳实践**
...
1. **主人只需“看到效果”** - 尽量少问问题
2. **先做一遍再告诉主人** - 30 秒一键启动
3. **主动执行状态切换** - 接任务前先切到“工作中”，完成后切回“待命”
4. **安全性优先** - 默认密码提醒改强密码
5. **API 可选** - 基础功能不依赖 API，先跑起来再说
6. **不要暴露内网地址** - 注意隐私保护
...
- Star-Office-UI 仓库：https://github.com/ringhyacinth/Star-Office-UI
